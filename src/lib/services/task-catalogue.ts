...
export const SERVICE_TASKS: ServiceTask[] = [
  ...
  {
    key: "igienizat_balustrade",
    nameRo: "Igienizat balustrade, mânere și interfon",
    nameEn: "Sanitise handrails, door handles and the intercom",
    zone: "balustrade",
    defaultFrequency: "saptamanal",
    inBasePackage: true,
  ...
  {
    key: "igienizat_lift",
    nameRo: "Igienizat butoanele, oglinda și pereții",
    nameEn: "Sanitise the buttons, mirror and walls",
    zone: "lift",
    defaultFrequency: "saptamanal",
    inBasePackage: true,
    competitorCoverage: 5,
